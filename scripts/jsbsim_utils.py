# https://github.com/jgoppert/aae451-notebook/blob/master/6-Simulation/jsbsim_utils.py
...
def simulate(aircraft, op_0, op_list=None, tf=50, show=False, realtime=False, verbose=False):
    if op_list is None:
        op_list = []
